...
⚠️ **Error frecuente en Windows:** Si al activar el entorno virtual te aparece un error de permisos como `UnauthorizedAccess`, ejecuta primero esto en PowerShell:
...
4. Crea un archivo llamado `.env` en la carpeta raíz del proyecto con este contenido:
...
⚠️ **Nunca subas el archivo `.env` a GitHub.** Ya está protegido por el `.gitignore` del proyecto.
